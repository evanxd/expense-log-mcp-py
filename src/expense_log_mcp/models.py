...
class Ledger(Base):
    ...
    createdAt = Column(DateTime, default=datetime.datetime.now(datetime.timezone.utc), name="created_at")
    updatedAt = Column(DateTime, default=datetime.datetime.now(datetime.timezone.utc), onupdate=datetime.datetime.now(datetime.timezone.utc), name="updated_at")
